<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="EmployeeManagementSystem.WebForm2" %>
        ...
        <div class="right-section">
            ...
            <form id="form1" runat="server">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="form-control" placeholder="Confirm your password" TextMode="Password" required="required" />
                </div>
                <div class="form-group">
                    <asp:Button ID="btnSignUp" runat="server" Text="Sign Up" CssClass="form-control" OnClick="SignUp_Click" />
                </div>
                <asp:Label ID="cnf" runat="server"></asp:Label>
            </form>
        </div>
    </div>
</body>
